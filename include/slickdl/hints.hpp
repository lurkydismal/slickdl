...
//
// Can be set anytime.
constexpr std::string_view g_allowAltTabWhileGrabbed =
...
constexpr std::string_view g_allowRecreateActivity =
...
constexpr std::string_view g_blockOnPause = "SDL_ANDROID_BLOCK_ON_PAUSE";
...
constexpr std::string_view g_lowLatencyAudio = "SDL_ANDROID_LOW_LATENCY_AUDIO";
...
//
// This hint can be set anytime.
constexpr std::string_view g_trapBackButton = "SDL_ANDROID_TRAP_BACK_BUTTON";
...
//
// This hint should be set before SDL is initialized.
constexpr std::string_view g_id = "SDL_APP_ID";
...
//
// This hint should be set before SDL is initialized.
constexpr std::string_view g_name = "SDL_APP_NAME";
...
//
// This hint can be set anytime.
constexpr std::string_view g_tvControllerUiEvents =
...
//
// This hint can be set anytime.
constexpr std::string_view g_tvRemoteAllowRotation =
...
constexpr std::string_view g_defaultDevice = "SDL_AUDIO_ALSA_DEFAULT_DEVICE";
...
//
// This hint should be set before an audio device is opened.
constexpr std::string_view g_defaultPlaybackDevice =
...
//
// This hint should be set before an audio device is opened.
constexpr std::string_view g_defaultRecordingDevice =
...
//
// This hint should be set before an audio device is opened.
constexpr std::string_view g_category = "SDL_AUDIO_CATEGORY";
...
//
// This hint should be set before an audio device is opened.
constexpr std::string_view g_channels = "SDL_AUDIO_CHANNELS";
...
//
// This hint should be set before an audio device is opened.
constexpr std::string_view g_appIconName = "SDL_AUDIO_DEVICE_APP_ICON_NAME";
...
//
// This hint should be set before an audio device is opened.
constexpr std::string_view g_sampleFrames = "SDL_AUDIO_DEVICE_SAMPLE_FRAMES";
...
//
// This hint should be set before an audio device is opened.
constexpr std::string_view g_name = "SDL_AUDIO_DEVICE_STREAM_NAME";
...
//
// This hint should be set before an audio device is opened.
constexpr std::string_view g_role = "SDL_AUDIO_DEVICE_STREAM_ROLE";
...
//
// This hint should be set before an audio device is opened.
constexpr std::string_view g_inputFile = "SDL_AUDIO_DISK_INPUT_FILE";
...
//
// This hint should be set before an audio device is opened.
constexpr std::string_view g_outputFile = "SDL_AUDIO_DISK_OUTPUT_FILE";
...
//
// This hint should be set before an audio device is opened.
constexpr std::string_view g_timescale = "SDL_AUDIO_DISK_TIMESCALE";
...
//
// This hint should be set before SDL is initialized.
constexpr std::string_view g_driver = "SDL_AUDIO_DRIVER";
...
//
// This hint should be set before an audio device is opened.
constexpr std::string_view g_dummyTimescale = "SDL_AUDIO_DUMMY_TIMESCALE";
...
//
// This hint should be set before an audio device is opened.
constexpr std::string_view g_format = "SDL_AUDIO_FORMAT";
...
//
// This hint should be set before an audio device is opened.
constexpr std::string_view g_frequency = "SDL_AUDIO_FREQUENCY";
...
//
// This hint should be set before SDL is initialized.
constexpr std::string_view g_includeMonitors = "SDL_AUDIO_INCLUDE_MONITORS";
...
//
// This hint can be set anytime.
constexpr std::string_view g_autoUpdateJoysticks = "SDL_AUTO_UPDATE_JOYSTICKS";
...
//
// This hint can be set anytime.
constexpr std::string_view g_autoUpdateSensors = "SDL_AUTO_UPDATE_SENSORS";
...
//
// This hint can be set anytime.
constexpr std::string_view g_bmpSaveLegacyFormat = "SDL_BMP_SAVE_LEGACY_FORMAT";
...
constexpr std::string_view g_cameraDriver = "SDL_CAMERA_DRIVER";
...
constexpr std::string_view g_cpuFeatureMask = "SDL_CPU_FEATURE_MASK";
...
//
// This hint should be set before SDL is initialized.
constexpr std::string_view g_joystickDirectinput = "SDL_JOYSTICK_DIRECTINPUT";
...
//
// This hint can be set anytime.
constexpr std::string_view g_fileDialogDriver = "SDL_FILE_DIALOG_DRIVER";
...
//
// This hint can be set anytime.
constexpr std::string_view g_displayUsableBounds = "SDL_DISPLAY_USABLE_BOUNDS";
...
//
// This hint can be set anytime.
constexpr std::string_view g_emscriptenAsyncify = "SDL_EMSCRIPTEN_ASYNCIFY";
...
constexpr std::string_view g_emscriptenCanvasSelector =
...
//
// This hint should be set before creating a window.
constexpr std::string_view g_emscriptenKeyboardElement =
...
constexpr std::string_view g_enableScreenKeyboard =
...
//
// This hint should be set before SDL is initialized.
constexpr std::string_view g_evdevDevices = "SDL_EVDEV_DEVICES";
...
//
// This hint can be set anytime.
constexpr std::string_view g_eventLogging = "SDL_EVENT_LOGGING";
...
//
// This hint can be set anytime.
constexpr std::string_view g_forceRaisewindow = "SDL_FORCE_RAISEWINDOW";
...
constexpr std::string_view g_framebufferAcceleration =
...
//
// This hint should be set before SDL is initialized.
constexpr std::string_view g_config = "SDL_GAMECONTROLLERCONFIG";
...
//
// This hint should be set before SDL is initialized.
constexpr std::string_view g_configFile = "SDL_GAMECONTROLLERCONFIG_FILE";
...
//
// This hint should be set before SDL is initialized.
constexpr std::string_view g_type = "SDL_GAMECONTROLLERTYPE";
...
//
// This hint can be set anytime.
constexpr std::string_view g_ignoreDevices =
...
//
// This hint can be set anytime.
constexpr std::string_view g_ignoreDevicesExcept =
...
constexpr std::string_view g_sensorFusion = "SDL_GAMECONTROLLER_SENSOR_FUSION";

} // namespace game_controller

namespace gdk::text_input {
...
constexpr std::string_view g_defaultText = "SDL_GDK_TEXTINPUT_DEFAULT_TEXT";
...
//
// This hint should be set before calling SDL_StartTextInput()
constexpr std::string_view g_description = "SDL_GDK_TEXTINPUT_DESCRIPTION";
...
//
// This hint should be set before calling SDL_StartTextInput()
constexpr std::string_view g_maxLength = "SDL_GDK_TEXTINPUT_MAX_LENGTH";
...
//
// This hint should be set before calling SDL_StartTextInput()
constexpr std::string_view g_scope = "SDL_GDK_TEXTINPUT_SCOPE";
...
//
// This hint should be set before calling SDL_StartTextInput()
constexpr std::string_view g_title = "SDL_GDK_TEXTINPUT_TITLE";
...
//
// This hint should be set before SDL is initialized.
constexpr std::string_view g_libusb = "SDL_HIDAPI_LIBUSB";
...
//
// This hint should be set before SDL is initialized.
constexpr std::string_view g_libusbWhitelist = "SDL_HIDAPI_LIBUSB_WHITELIST";
...
//
// This hint should be set before SDL is initialized.
constexpr std::string_view g_udev = "SDL_HIDAPI_UDEV";
...
//
// This hint can be set anytime.
constexpr std::string_view g_enumerateOnlyControllers =
...
//
// This hint can be set anytime.
constexpr std::string_view g_ignoreDevices = "SDL_HIDAPI_IGNORE_DEVICES";
...
constexpr std::string_view g_gpuDriver = "SDL_GPU_DRIVER";
...
//
// This hint should be set before SDL is initialized.
constexpr std::string_view g_imeImplementedUi = "SDL_IME_IMPLEMENTED_UI";
...
//
// This hint can be set anytime.
constexpr std::string_view g_iosHideHomeIndicator =
...
//
// This hint can be set anytime.
constexpr std::string_view g_allowBackgroundEvents =
...
//
// This hint can be set anytime.
constexpr std::string_view g_arcadestickDevices =
...
//
// This hint can be set anytime.
constexpr std::string_view g_arcadestickDevicesExcluded =
...
//
// This hint can be set anytime.
constexpr std::string_view g_blacklistDevices =
...
//
// This hint can be set anytime.
constexpr std::string_view g_blacklistDevicesExcluded =
...
constexpr std::string_view g_device = "SDL_JOYSTICK_DEVICE";
...
constexpr std::string_view g_enhancedReports = "SDL_JOYSTICK_ENHANCED_REPORTS";
...
//
// This hint can be set anytime.
constexpr std::string_view g_flightstickDevices =
...
//
// This hint can be set anytime.
constexpr std::string_view g_flightstickDevicesExcluded =
...
//
// This hint should be set before SDL is initialized.
constexpr std::string_view g_gameinput = "SDL_JOYSTICK_GAMEINPUT";
...
//
// This hint can be set anytime.
constexpr std::string_view g_gamecubeDevices = "SDL_JOYSTICK_GAMECUBE_DEVICES";
...
//
// This hint can be set anytime.
constexpr std::string_view g_gamecubeDevicesExcluded =
...
constexpr std::string_view g_hidapi = "SDL_JOYSTICK_HIDAPI";
...
//
// This hint should be set before initializing joysticks and gamepads.
constexpr std::string_view g_combineJoyCons =
...
//
// This hint should be set before initializing joysticks and gamepads.
constexpr std::string_view g_gamecube = "SDL_JOYSTICK_HIDAPI_GAMECUBE";
...
//
// This hint can be set anytime.
constexpr std::string_view g_rumbleBrake =
...
//
// This hint should be set before initializing joysticks and gamepads.
constexpr std::string_view g_joyCons = "SDL_JOYSTICK_HIDAPI_JOY_CONS";
...
//
// This hint can be set anytime.
constexpr std::string_view g_homeLed = "SDL_JOYSTICK_HIDAPI_JOYCON_HOME_LED";
...
constexpr std::string_view g_verticalJoyCons =
...
//
// This hint should be set before initializing joysticks and gamepads.
constexpr std::string_view g_luna = "SDL_JOYSTICK_HIDAPI_LUNA";
...
//
// This hint should be set before initializing joysticks and gamepads.
constexpr std::string_view g_nintendoClassic =
...
//
// This hint should be set before initializing joysticks and gamepads.
constexpr std::string_view g_pS3 = "SDL_JOYSTICK_HIDAPI_PS3";
...
//
// This hint should be set before initializing joysticks and gamepads.
constexpr std::string_view g_sixAxisDriver =
...
//
// This hint should be set before initializing joysticks and gamepads.
constexpr std::string_view g_pS4 = "SDL_JOYSTICK_HIDAPI_PS4";
...
// reports are enabled.
constexpr std::string_view g_reportInterval =
...
//
// This hint should be set before initializing joysticks and gamepads.
constexpr std::string_view g_pS5 = "SDL_JOYSTICK_HIDAPI_PS5";
...
constexpr std::string_view g_playerLed = "SDL_JOYSTICK_HIDAPI_PS5_PLAYER_LED";
...
//
// This hint should be set before initializing joysticks and gamepads.
constexpr std::string_view g_shield = "SDL_JOYSTICK_HIDAPI_SHIELD";
...
//
// The default is the value of SDL_HINT_JOYSTICK_HIDAPI.
constexpr std::string_view g_stadia = "SDL_JOYSTICK_HIDAPI_STADIA";
...
//
// This hint should be set before initializing joysticks and gamepads.
constexpr std::string_view g_steam = "SDL_JOYSTICK_HIDAPI_STEAM";
...
//
// This hint can be set anytime.
constexpr std::string_view g_homeLed = "SDL_JOYSTICK_HIDAPI_STEAM_HOME_LED";
...
//
// This hint should be set before initializing joysticks and gamepads.
constexpr std::string_view g_deck = "SDL_JOYSTICK_HIDAPI_STEAMDECK";
...
constexpr std::string_view g_hori = "SDL_JOYSTICK_HIDAPI_STEAM_HORI";
...
// - "0": HIDAPI driver is not used
// - "1": HIDAPI driver is used
constexpr std::string_view g_lG4Ff = "SDL_JOYSTICK_HIDAPI_LG4FF";
...
constexpr std::string_view g_8Bitdo = "SDL_JOYSTICK_HIDAPI_8BITDO";
...
//
// "0" - HIDAPI driver is not used. "1" - HIDAPI driver is used.
constexpr std::string_view g_flydigi = "SDL_JOYSTICK_HIDAPI_FLYDIGI";
...
//
// This hint should be set before initializing joysticks and gamepads.
constexpr std::string_view g_switch = "SDL_JOYSTICK_HIDAPI_SWITCH";
...
//
// This hint can be set anytime.
constexpr std::string_view g_homeLed = "SDL_JOYSTICK_HIDAPI_SWITCH_HOME_LED";
...
//
// This hint can be set anytime.
constexpr std::string_view g_playerLed =
...
//
// This hint should be set before initializing joysticks and gamepads.
constexpr std::string_view g_wii = "SDL_JOYSTICK_HIDAPI_WII";

namespace nintendo_wii {
...
//
// This hint can be set anytime.
constexpr std::string_view g_playerLed = "SDL_JOYSTICK_HIDAPI_WII_PLAYER_LED";
...
//
// This hint should be set before initializing joysticks and gamepads.
constexpr std::string_view g_xbox = "SDL_JOYSTICK_HIDAPI_XBOX";
...
//
// This hint should be set before initializing joysticks and gamepads.
constexpr std::string_view g_xbox360 = "SDL_JOYSTICK_HIDAPI_XBOX_360";
...
//
// This hint should be set before initializing joysticks and gamepads.
constexpr std::string_view g_wireless = "SDL_JOYSTICK_HIDAPI_XBOX_360_WIRELESS";
...
//
// This hint should be set before initializing joysticks and gamepads.
constexpr std::string_view g_xboxOne = "SDL_JOYSTICK_HIDAPI_XBOX_ONE";
...
//
// This hint can be set anytime.
constexpr std::string_view g_homeLed = "SDL_JOYSTICK_HIDAPI_XBOX_ONE_HOME_LED";
...
//
// This hint should be set before initializing joysticks and gamepads.
constexpr std::string_view g_gip = "SDL_JOYSTICK_HIDAPI_GIP";
...
//
// This hint should be set before initializing joysticks and gamepads.
constexpr std::string_view g_resetForMetadata =
...
//
// This hint should be set before SDL is initialized.
constexpr std::string_view g_iokit = "SDL_JOYSTICK_IOKIT";
...
//
// This hint should be set before SDL is initialized.
constexpr std::string_view g_classic = "SDL_JOYSTICK_LINUX_CLASSIC";
...
constexpr std::string_view g_deadzones = "SDL_JOYSTICK_LINUX_DEADZONES";
...
//
// This hint should be set before a controller is opened.
constexpr std::string_view g_digitalHats = "SDL_JOYSTICK_LINUX_DIGITAL_HATS";
...
//
// This hint should be set before a controller is opened.
constexpr std::string_view g_hatDeadzones = "SDL_JOYSTICK_LINUX_HAT_DEADZONES";
...
//
// This hint should be set before SDL is initialized.
constexpr std::string_view g_mfi = "SDL_JOYSTICK_MFI";
...
//
// This hint should be set before SDL is initialized.
constexpr std::string_view g_rawinput = "SDL_JOYSTICK_RAWINPUT";
...
//
// This hint should be set before a gamepad is opened.
constexpr std::string_view g_rawinputCorrelateXinput =
...
//
// This hint should be set before SDL is initialized.
constexpr std::string_view g_rogChakram = "SDL_JOYSTICK_ROG_CHAKRAM";
...
//
// This hint should be set before SDL is initialized.
constexpr std::string_view g_thread = "SDL_JOYSTICK_THREAD";
...
//
// This hint can be set anytime.
constexpr std::string_view g_throttleDevices = "SDL_JOYSTICK_THROTTLE_DEVICES";
...
//
// This hint can be set anytime.
constexpr std::string_view g_throttleDevicesExcluded =
...
//
// This hint should be set before SDL is initialized.
constexpr std::string_view g_wgi = "SDL_JOYSTICK_WGI";
...
//
// This hint can be set anytime.
constexpr std::string_view g_wheelDevices = "SDL_JOYSTICK_WHEEL_DEVICES";
...
//
// This hint can be set anytime.
constexpr std::string_view g_wheelDevicesExcluded =
...
//
// This hint should be set before a controller is opened.
constexpr std::string_view g_zeroCenteredDevices =
...
constexpr std::string_view g_hapticAxes = "SDL_JOYSTICK_HAPTIC_AXES";
...
//
// This hint can be set anytime.
constexpr std::string_view g_keycodeOptions = "SDL_KEYCODE_OPTIONS";
...
//
// This hint should be set before SDL is initialized.
constexpr std::string_view g_deviceIndex = "SDL_KMSDRM_DEVICE_INDEX";
...
//
// This hint should be set before SDL is initialized.
constexpr std::string_view g_requireDrmMaster = "SDL_KMSDRM_REQUIRE_DRM_MASTER";
...
//
// This hint can be set anytime.
constexpr std::string_view g_logging = "SDL_LOGGING";
...
constexpr std::string_view g_backgroundApp = "SDL_MAC_BACKGROUND_APP";
...
//
// This hint can be set anytime.
constexpr std::string_view g_ctrlClickEmulateRightClick =
...
//
// This hint can be set anytime.
constexpr std::string_view g_openglAsyncDispatch =
...
//
// This hint can be set anytime.
constexpr std::string_view g_optionAsAlt = "SDL_MAC_OPTION_AS_ALT";
...
//
// This hint needs to be set before SDL_Init().
constexpr std::string_view g_scrollMomentum = "SDL_MAC_SCROLL_MOMENTUM";
...
//
// This hint can be set anytime.
constexpr std::string_view g_mainCallbackRate = "SDL_MAIN_CALLBACK_RATE";
...
//
// This hint can be set anytime.
constexpr std::string_view g_autoCapture = "SDL_MOUSE_AUTO_CAPTURE";

// A variable setting the double click radius, in pixels.
//
// This hint can be set anytime.
constexpr std::string_view g_doubleClickRadius =
    "SDL_MOUSE_DOUBLE_CLICK_RADIUS";

// A variable setting the double click time, in milliseconds.
//
// This hint can be set anytime.
constexpr std::string_view g_doubleClickTime = "SDL_MOUSE_DOUBLE_CLICK_TIME";
...
//
// This hint needs to be set before SDL_Init().
constexpr std::string_view g_defaultSystemCursor =
...
//
// This hint can be set anytime.
constexpr std::string_view g_emulateWarpWithRelative =
...
//
// This hint can be set anytime.
constexpr std::string_view g_focusClickthrough = "SDL_MOUSE_FOCUS_CLICKTHROUGH";

// A variable setting the speed scale for mouse motion, in floating point,
// when the mouse is not in relative mode.
//
// This hint can be set anytime.
constexpr std::string_view g_normalSpeedScale = "SDL_MOUSE_NORMAL_SPEED_SCALE";
...
//
// This hint can be set anytime.
constexpr std::string_view g_relativeModeCenter =
...
//
// This hint can be set anytime.
constexpr std::string_view g_relativeSpeedScale =
...
//
// This hint can be set anytime.
constexpr std::string_view g_relativeSystemScale =
...
//
// This hint can be set anytime.
constexpr std::string_view g_relativeWarpMotion =
...
//
// This hint can be set anytime.
constexpr std::string_view g_relativeCursorVisible =
...
//
// This hint can be set anytime.
constexpr std::string_view g_touchEvents = "SDL_MOUSE_TOUCH_EVENTS";
...
//
// This hint should be set before SDL is initialized.
constexpr std::string_view g_muteConsoleKeyboard = "SDL_MUTE_CONSOLE_KEYBOARD";
...
//
// This hint should be set before SDL is initialized.
constexpr std::string_view g_noSignalHandlers = "SDL_NO_SIGNAL_HANDLERS";
...
// default.
constexpr std::string_view g_eglLibrary = "SDL_EGL_LIBRARY";
...
// default.
constexpr std::string_view g_library = "SDL_OPENGL_LIBRARY";
...
//
// This hint should be set before SDL is initialized.
constexpr std::string_view g_esDriver = "SDL_OPENGL_ES_DRIVER";
...
constexpr std::string_view g_openvrLibrary = "SDL_OPENVR_LIBRARY";
...
//
// This hint should be set before SDL is initialized.
constexpr std::string_view g_orientations = "SDL_ORIENTATIONS";
...
//
// This hint can be set anytime.
constexpr std::string_view g_pollSentinel = "SDL_POLL_SENTINEL";
...
//
// This hint can be set anytime.
constexpr std::string_view g_preferredLocales = "SDL_PREFERRED_LOCALES";
...
//
// This hint can be set anytime.
constexpr std::string_view g_quitOnLastWindowClose =
...
constexpr std::string_view g_direcT3DThreadsafe =
...
//
// This hint should be set before creating a renderer.
constexpr std::string_view g_direcT3D11Debug = "SDL_RENDER_DIRECT3D11_DEBUG";
...
constexpr std::string_view g_vulkanDebug = "SDL_RENDER_VULKAN_DEBUG";
...
//
// This hint should be set before creating a renderer.
constexpr std::string_view g_gpuDebug = "SDL_RENDER_GPU_DEBUG";
...
//
// This hint should be set before creating a renderer.
constexpr std::string_view g_gpuLowPower = "SDL_RENDER_GPU_LOW_POWER";
...
//
// This hint should be set before creating a renderer.
constexpr std::string_view g_driver = "SDL_RENDER_DRIVER";
...
//
// This hint should be set before creating a renderer.
constexpr std::string_view g_lineMethod = "SDL_RENDER_LINE_METHOD";
...
//
// This hint should be set before creating a renderer.
constexpr std::string_view g_metalPreferLowPowerDevice =
...
//
// This hint should be set before creating a renderer.
constexpr std::string_view g_vsync = "SDL_RENDER_VSYNC";
...
//
// This hint can be set anytime.
constexpr std::string_view g_returnKeyHidesIme = "SDL_RETURN_KEY_HIDES_IME";

namespace rog_gamepad {
...
constexpr std::string_view g_mice = "SDL_ROG_GAMEPAD_MICE";
...
//
// This hint should be set before SDL is initialized.
constexpr std::string_view g_miceExcluded = "SDL_ROG_GAMEPAD_MICE_EXCLUDED";
...
//
// This hint should be set before SDL is initialized.
constexpr std::string_view g_rpiVideoLayer = "SDL_RPI_VIDEO_LAYER";
...
constexpr std::string_view g_screensaverInhibitActivityName =
...
//
// This hint can be set anytime.
constexpr std::string_view g_shutdownDbusOnQuit = "SDL_SHUTDOWN_DBUS_ON_QUIT";
...
//
// This hint should be set before SDL is initialized.
constexpr std::string_view g_titleDriver = "SDL_STORAGE_TITLE_DRIVER";
...
//
// This hint should be set before SDL is initialized.
constexpr std::string_view g_userDriver = "SDL_STORAGE_USER_DRIVER";
...
constexpr std::string_view g_threadForceRealtimeTimeCritical =
...
//
// This hint should be set before calling SDL_SetCurrentThreadPriority()
constexpr std::string_view g_threadPriorityPolicy =
...
//
// This hint can be set anytime.
constexpr std::string_view g_timerResolution = "SDL_TIMER_RESOLUTION";
...
//
// This hint can be set anytime.
constexpr std::string_view g_touchMouseEvents = "SDL_TOUCH_MOUSE_EVENTS";
...
//
// This hint should be set before SDL is initialized.
constexpr std::string_view g_trackpadIsTouchOnly = "SDL_TRACKPAD_IS_TOUCH_ONLY";
...
//
// This hint should be set before SDL is initialized.
constexpr std::string_view g_tvRemoteAsJoystick = "SDL_TV_REMOTE_AS_JOYSTICK";
...
//
// This hint should be set before SDL is initialized.
constexpr std::string_view g_allowScreensaver = "SDL_VIDEO_ALLOW_SCREENSAVER";
...
//
// This hint should be set before SDL is initialized.
constexpr std::string_view g_displayPriority = "SDL_VIDEO_DISPLAY_PRIORITY";
...
//
// This hint should be set before SDL is initialized.
constexpr std::string_view g_doubleBuffer = "SDL_VIDEO_DOUBLE_BUFFER";
...
//
// This hint should be set before SDL is initialized.
constexpr std::string_view g_driver = "SDL_VIDEO_DRIVER";
...
//
// This hint can be set anytime.
constexpr std::string_view g_dummySaveFrames = "SDL_VIDEO_DUMMY_SAVE_FRAMES";
...
//
// This hint should be set before SDL is initialized.
constexpr std::string_view g_eglAllowGetdisplayFallback =
...
//
// This hint should be set before SDL is initialized.
constexpr std::string_view g_forceEgl = "SDL_VIDEO_FORCE_EGL";
...
//
// This hint should be set before creating a window.
constexpr std::string_view g_macFullscreenSpaces =
...
//
// This hint can be set anytime.
constexpr std::string_view g_macFullscreenMenuVisibility =
...
//
// This hint can be set anytime.
constexpr std::string_view g_matchExclusiveModeOnMove =
...
//
// This hint can be set anytime.
constexpr std::string_view g_minimizeOnFocusLoss =
...
//
// This hint can be set anytime.
constexpr std::string_view g_offscreenSaveFrames =
...
//
// This hint can be set anytime.
constexpr std::string_view g_syncWindowOperations =
...
//
// This hint should be set before SDL is initialized.
constexpr std::string_view g_waylandAllowLibdecor =
...
//
// This hint should be set before SDL is initialized.
constexpr std::string_view g_waylandModeEmulation =
...
//
// This hint should be set before creating a window.
constexpr std::string_view g_waylandModeScaling =
...
//
// This hint should be set before SDL is initialized.
constexpr std::string_view g_waylandPreferLibdecor =
...
//
// This hint should be set before creating a window.
constexpr std::string_view g_waylandScaleToDisplay =
...
//
// This hint should be set before SDL is initialized.
constexpr std::string_view g_winD3Dcompiler = "SDL_VIDEO_WIN_D3DCOMPILER";
...
//
// This hint should be set before creating a window.
constexpr std::string_view g_externalWindowInput =
...
//
// This hint should be set before creating a window.
constexpr std::string_view g_netWmBypassCompositor =
...
//
// This hint should be set before creating a window.
constexpr std::string_view g_netWmPing = "SDL_VIDEO_X11_NET_WM_PING";
...
constexpr std::string_view g_nodirectcolor = "SDL_VIDEO_X11_NODIRECTCOLOR";
...
//
// This hint should be set before SDL is initialized.
constexpr std::string_view g_scalingFactor = "SDL_VIDEO_X11_SCALING_FACTOR";

// A variable forcing the visual ID used for X11 display modes.
//
// This hint should be set before initializing the video subsystem.
constexpr std::string_view g_visualid = "SDL_VIDEO_X11_VISUALID";

// A variable forcing the visual ID chosen for new X11 windows.
//
// This hint should be set before creating a window.
constexpr std::string_view g_windowVisualid = "SDL_VIDEO_X11_WINDOW_VISUALID";
...
//
// This hint should be set before SDL is initialized.
constexpr std::string_view g_xrandr = "SDL_VIDEO_X11_XRANDR";
...
//
// This hint should be set before SDL is initialized.
constexpr std::string_view g_enableBackTouch = "SDL_VITA_ENABLE_BACK_TOUCH";
...
//
// This hint should be set before SDL is initialized.
constexpr std::string_view g_enableFrontTouch = "SDL_VITA_ENABLE_FRONT_TOUCH";
...
//
// This hint should be set before SDL is initialized.
constexpr std::string_view g_modulePath = "SDL_VITA_MODULE_PATH";
...
//
// This hint should be set before SDL is initialized.
constexpr std::string_view g_pvrInit = "SDL_VITA_PVR_INIT";
...
//
// This hint should be set before SDL is initialized.
constexpr std::string_view g_resolution = "SDL_VITA_RESOLUTION";
...
//
// This hint should be set before SDL is initialized.
constexpr std::string_view g_pvrOpengl = "SDL_VITA_PVR_OPENGL";
...
//
// This hint can be set anytime.
constexpr std::string_view g_touchMouseDevice = "SDL_VITA_TOUCH_MOUSE_DEVICE";
...
constexpr std::string_view g_display = "SDL_VULKAN_DISPLAY";

// Specify the Vulkan library to load.
//
// This hint should be set before creating a Vulkan window or calling
// SDL_Vulkan_LoadLibrary().
constexpr std::string_view g_library = "SDL_VULKAN_LIBRARY";
...
constexpr std::string_view g_factChunk = "SDL_WAVE_FACT_CHUNK";
...
//
// This hint should be set before calling SDL_LoadWAV() or SDL_LoadWAV_IO()
constexpr std::string_view g_chunkLimit = "SDL_WAVE_CHUNK_LIMIT";
...
//
// This hint should be set before calling SDL_LoadWAV() or SDL_LoadWAV_IO()
constexpr std::string_view g_riffChunkSize = "SDL_WAVE_RIFF_CHUNK_SIZE";
...
//
// This hint should be set before calling SDL_LoadWAV() or SDL_LoadWAV_IO()
constexpr std::string_view g_truncation = "SDL_WAVE_TRUNCATION";
...
//
// This hint can be set anytime.
constexpr std::string_view g_activateWhenRaised =
...
//
// This hint can be set anytime.
constexpr std::string_view g_activateWhenShown =
...
//
// This hint can be set anytime.
constexpr std::string_view g_allowTopmost = "SDL_WINDOW_ALLOW_TOPMOST";
...
//
// This hint can be set anytime.
constexpr std::string_view g_frameUsableWhileCursorHidden =
...
//
// This hint can be set anytime.
constexpr std::string_view g_closeOnAltF4 = "SDL_WINDOWS_CLOSE_ON_ALT_F4";
...
//
// This hint can be set anytime.
constexpr std::string_view g_enableMenuMnemonics =
...
//
// This hint can be set anytime.
constexpr std::string_view g_enableMessageloop =
...
//
// This hint should be set before SDL is initialized.
constexpr std::string_view g_gameinput = "SDL_WINDOWS_GAMEINPUT";
...
//
// This hint can be set anytime.
constexpr std::string_view g_rawKeyboard = "SDL_WINDOWS_RAW_KEYBOARD";
...
//
// This hint should be set before SDL is initialized.
constexpr std::string_view g_forceSemaphoreKernel =
...
//
// This hint should be set before SDL is initialized.
constexpr std::string_view g_intresourceIcon = "SDL_WINDOWS_INTRESOURCE_ICON";

// A variable to specify custom icon resource id from RC file on Windows
// platform.
//
// This hint should be set before SDL is initialized.
constexpr std::string_view g_intresourceIconSmall =
...
//
// This hint should be set before SDL is initialized.
constexpr std::string_view g_useD3D9Ex = "SDL_WINDOWS_USE_D3D9EX";
...
//
// This hint should be set before creating a window.
constexpr std::string_view g_eraseBackgroundMode =
...
//
// This hint should be set before creating a window.
constexpr std::string_view g_forceOverrideRedirect =
...
//
// This hint should be set before creating a window.
constexpr std::string_view g_windowType = "SDL_X11_WINDOW_TYPE";
...
//
// This hint should be set before initializing the video subsystem.
constexpr std::string_view g_xcbLibrary = "SDL_X11_XCB_LIBRARY";
...
//
// This hint should be set before SDL is initialized.
constexpr std::string_view g_xinputEnabled = "SDL_XINPUT_ENABLED";
...
// changed at any time.
constexpr std::string_view g_assert = "SDL_ASSERT";
...
//
// This hint can be set anytime.
constexpr std::string_view g_mouseEvents = "SDL_PEN_MOUSE_EVENTS";
...
//
// This hint can be set anytime.
constexpr std::string_view g_touchEvents = "SDL_PEN_TOUCH_EVENTS";

} // namespace pen

// An enumeration of hint priorities.
using priority_t = enum class priority : uint8_t {
    based,
    normal,
    override,
};

using priorityUnderlying_t = std::underlying_type_t< priority_t >;

[[nodiscard]] constexpr auto toLegacy( priority_t _value ) -> SDL_HintPriority {
    return ( static_cast< SDL_HintPriority >( _value ) );
}

[[nodiscard]] constexpr auto toLegacy( priority_t* _value )
    -> SDL_HintPriority* {
    return ( std::bit_cast< SDL_HintPriority* >( _value ) );
}

[[nodiscard]] constexpr auto fromLegacy( SDL_HintPriority _value )
    -> priority_t {
    return ( static_cast< priority_t >( _value ) );
}
...
inline void set( std::string_view _name,
                 std::string_view _value,
                 priority_t _priority ) {
    const bool l_result = SDL_SetHintWithPriority(
        std::string( _name ).c_str(), std::string( _value ).c_str(),
        toLegacy( _priority ) );
...
inline void set( std::string_view _name, std::string_view _value ) {
    const bool l_result = SDL_SetHint( std::string( _name ).c_str(),
...
// change.
inline void reset( std::string_view _name ) {
    const bool l_result = SDL_ResetHint( std::string( _name ).c_str() );
...
// only remains valid until the hint is changed; if another thread might do so,
// the app should supply locks and/or make a copy of the string. Note that using
// a hint callback instead is always thread-safe, as SDL holds a lock on the
// thread subsystem during the callback.
[[nodiscard]] inline auto get( std::string_view _name )
    -> std::optional< std::string_view > {
    const char* l_result = SDL_GetHint( std::string( _name ).c_str() );
...
[[nodiscard]] inline auto get( std::string_view _name, bool _defaultValue )
    -> bool {
    return (
        SDL_GetHintBoolean( std::string( _name ).c_str(), _defaultValue ) );
}
...
//
// This callback is fired from whatever thread is setting a new hint value. SDL
// holds a lock on the hint subsystem when calling this callback.
using callback_t = gsl::not_null< SDL_HintCallback >;

// Add a function to watch a particular hint.
//
// The callback function is called _during_ this function, to provide it an
// initial value, and again each time the hint's value changes.
inline void add( std::string_view _name,
                 callback_t _callback,
                 void* _userData = nullptr ) {
    const bool l_result = SDL_AddHintCallback( std::string( _name ).c_str(),
                                               _callback, _userData );
...
inline void remove( std::string_view _name,
                    callback_t _callback,
                    void* _userdData = nullptr ) {
    SDL_RemoveHintCallback( std::string( _name ).c_str(), _callback,
                            _userdData );
}
